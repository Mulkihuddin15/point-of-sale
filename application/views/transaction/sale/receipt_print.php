...
<head>
    <title>MyStore - Print Nota</title>
    <style type="text/css">
        html {
...
<body onload="window.print()">
    <div class="content">
        <div class="title">
            <b>Store Skuy</b>
            <br>
            Jl. Raya Labuhan Lombok, Pringgabaya
        </div>
        ...
        <div class="transaction">
            <table class="transaction-table" cellspacing="0" cellpadding="0">
                ...
                foreach ($sale_detail as $key => $value) { ?>
                    <tr>
                        ...
                        <td style="text-align:right; width:60px">
                            <?= indo_currency($value->price - $value->discount_item * $value->qty) ?></td>
                    </tr>
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="border-top:1px dashed; text-align:right; padding:5px">Cash</td>
